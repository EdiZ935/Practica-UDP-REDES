...
public class Servidor {
        ...
        if (type==0){
            ...
            switch (instr){
                ...
                case 2:
                    ...
                    getFile(ds, IA, p);// Caso 2: Se manda a recibir el nombre y album de la canción que se desea descargar
    ...
    public static void getFile(DatagramSocket ds, InetAddress IA, DatagramPacket p)throws IOException{
    ...
    public static File getDirectory(String albumName){
